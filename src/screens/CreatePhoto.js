        ...
        <>
        {
            ...
            <div className = 'hire-body create-photo-main'>
                        ...
                        <div className = "signup-fields">
                            ...
                            <div className = 'field'>
                                ...
                                <div className = 'field'>
                                    ...
                                    <div className = "field-input">
                                        <input name='shotDate' type="date" onChange = { handleInputChange }/>
                                    </div>
                                </div>
                                <br />
                                <div className = 'field'>
                                    ...
                                    <div className = "field-input">
                                        <input name='cameraInfo' type="text" onChange = { handleInputChange }/>
                                    </div>
                                </div>
                                <br />
                                <div className = 'field'>
                                    ...
                                    <div className = "field-input">
                                        <input name='shotLocation' type="text" onChange = { handleInputChange }/>
                                    </div>
                                </div>
                                <br />
                                <div className = 'field'>
                    ...
                    {previewSource && (
                        <div>
                        <h3>Preview</h3>
                        <img src={previewSource} alt="chosenfile" style = { {height: '300px'}} />
                        </div>
                    )}
            </div>
            </>
